...
$(document).ready(function() {
    ...
    //Vinyl
    $('#vinyl_button').bind('click', function() {

		$('.btn_avtovinyl').addClass('passive_button');
	  	$('#vinyl_button').removeClass('passive_button');
	  	$('#vinyl_button').addClass('active_button');

	    $('.vinyl_text').css("display", "none");
	    $('#vinyl').css("display", "block");
	});
	$('#vinyl_examples_button').bind('click', function() {
	    
	  	$('.btn_avtovinyl').addClass('passive_button');
	  	$('#vinyl_examples_button').removeClass('passive_button');
	  	$('#vinyl_examples_button').addClass('active_button');

	  	$('.vinyl_text').css("display", "none");
	    $('#vinyl_examples').css("display", "block");
	});
	$('#vinyl_prices_button').bind('click', function() {
	    
	  	$('.btn_avtovinyl').addClass('passive_button');
	  	$('#vinyl_prices_button').removeClass('passive_button');
	  	$('#vinyl_prices_button').addClass('active_button');

	  	$('.vinyl_text').css("display", "none");
	    $('#vinyl_prices').css("display", "block");
	});

	//Tonirovka
	$('#tonirovka_button').bind('click', function() {

		$('.btn_avtovinyl').addClass('passive_button');
	  	$('#tonirovka_button').removeClass('passive_button');
	  	$('#tonirovka_button').addClass('active_button');

	    $('.vinyl_text').css("display", "none");
	    $('#tonirovka').css("display", "block");
	});
	$('#tonirovka_fonar_button').bind('click', function() {
	    
	  	$('.btn_avtovinyl').addClass('passive_button');
	  	$('#tonirovka_fonar_button').removeClass('passive_button');
	  	$('#tonirovka_fonar_button').addClass('active_button');

	  	$('.vinyl_text').css("display", "none");
	    $('#tonirovka_fonar').css("display", "block");
	});
	$('#tonirovka_prices_button').bind('click', function() {
	    
	  	$('.btn_avtovinyl').addClass('passive_button');
	  	$('#tonirovka_prices_button').removeClass('passive_button');
	  	$('#tonirovka_prices_button').addClass('active_button');

	  	$('.vinyl_text').css("display", "none");
	    $('#tonirovka_prices').css("display", "block");
	});

	//Bronirovanie
	$('#zashita_button').bind('click', function() {

		$('.btn_avtovinyl').addClass('passive_button');
	  	$('#zashita_button').removeClass('passive_button');
	  	$('#zashita_button').addClass('active_button');

	    $('.vinyl_text').css("display", "none");
	    $('#zashita').css("display", "block");
	});
	$('#bronirovanie_button').bind('click', function() {
	    
	  	$('.btn_avtovinyl').addClass('passive_button');
	  	$('#bronirovanie_button').removeClass('passive_button');
	  	$('#bronirovanie_button').addClass('active_button');
